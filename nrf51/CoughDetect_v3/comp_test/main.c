...
nrf_drv_gpiote_in_config_t comp2_config = GPIOTE_CONFIG_IN_SENSE_LOTOHI(false);
...
int main(void) {
    ...
    nrf_drv_gpiote_in_init(COMP1, &comp1_config, comp1_handler);
    nrf_drv_gpiote_in_init(COMP2, &comp2_config, comp2_handler);
